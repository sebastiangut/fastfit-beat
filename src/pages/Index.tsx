...
import mainstageCover from '@/assets/mainstage_new.png';
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center mb-4">
            <img src="/fastfit_gold.png" alt="FastFit" className="h-20" />
          </div>
        ...
        {/* Featured station */}
        <div className="mb-8">
          <div className="relative rounded-2xl p-8 md:p-12 overflow-hidden group border border-white/10 shadow-glow">
            {/* Background Image */}
            <div className="absolute inset-0">
              ...
              />
              <div className="absolute inset-0 bg-black/60 group-hover:bg-black/50 transition-colors duration-500" /> {/* Overlay */}
            </div>

            <div className="relative z-10 flex flex-col items-start text-left">
              <div className="flex items-center space-x-3 mb-4">
                <Radio className="h-6 w-6 text-gym-primary" />
                <span className="text-sm font-semibold text-gym-primary uppercase tracking-wider">
                  Featured Station
                </span>
              </div>
              <h2 className="text-5xl md:text-7xl font-black italic mb-2 text-white">MAINSTAGE</h2>
              <p className="text-lg text-white/80 mb-6">Festival Hits, EDM, Top 40</p>
              <Button
                variant="default"
                size="lg"
                className="bg-gym-primary text-black hover:bg-gym-primary-glow hover:scale-105 transition-all shadow-[0_0_20px_rgba(255,255,0,0.3)] font-bold"
