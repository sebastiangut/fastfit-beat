...
const DEFAULT_STATIONS: Omit<RadioStation, 'createdAt' | 'updatedAt'>[] = [
  {
    ...
    streamUrl: 'https://fastfit.work.gd/hls/fastfit_mainstage/live.m3u8',
  ...
  },
  {
    ...
    streamUrl: 'https://fastfit.work.gd/hls/fastfit_classics/live.m3u8',
  ...
  },
  {
    ...
    streamUrl: 'https://fastfit.work.gd/hls/fastfit_chill/live.m3u8',
  ...
  },
  {
    ...
    streamUrl: 'https://fastfit.work.gd/hls/fastfit_organic/live.m3u8',
  ...
  },
  {
    ...
    name: 'Afro',
    genre: 'Afro House',
    streamUrl: 'https://fastfit.work.gd/hls/fastfit_afro/live.m3u8',
  ...
  },
  {
    ...
    streamUrl: 'https://fastfit.work.gd/hls/fastfit_house/live.m3u8',
